void PlotAttenuationThickness_waterOnly_concrete_iron(string particleType, bool Concrete = 0, bool Iron = 0, bool RealFlux = 0){
  ...
  string path_to_filesAttenuationGamma = "../EventSelection/TxtFiles_Thickness_vs_AttenuationGamma/" + particleType + "/" ;
  if (Concrete) {
    path_to_filesAttenuationGamma += "Concrete/" ;
    if (Iron)
      path_to_filesAttenuationGamma += "Iron/" ;
  }
    
  string fNameParticleWaterOnlyGamma1 = path_to_filesAttenuationGamma+"Thickness_vs_AttenuationGamma_WaterOnly_20MeV.txt";
  string fNameParticleWaterOnlyGamma2 = path_to_filesAttenuationGamma+"Thickness_vs_AttenuationGamma_WaterOnly_100MeV.txt";

  TGraphErrors *grParticleWaterOnlyGamma1 = new TGraphErrors(fNameParticleWaterOnlyGamma1.c_str(), "%lg %lg %lg", "");//ID
  TGraphErrors *grParticleWaterOnlyGamma2 = new TGraphErrors(fNameParticleWaterOnlyGamma2.c_str(), "%lg %lg %lg", "");//ID
  ...
  for ( int i = 0; i<grParticleWaterOnlyGamma1->GetN(); i++) {
    grParticleWaterOnlyGamma1->SetPointY(i,1-grParticleWaterOnlyGamma1->GetPointY(i));
  }
  ...
  grParticleWaterOnly1->GetXaxis()->SetAxisColor(gPad->GetFrameLineColor());
  grParticleWaterOnly1->GetYaxis()->SetAxisColor(gPad->GetFrameLineColor());
  
  grParticleWaterOnly1->GetXaxis()->SetTitleColor(gPad->GetFrameLineColor());
  grParticleWaterOnly1->GetXaxis()->SetLabelColor(gPad->GetFrameLineColor());
  grParticleWaterOnly1->GetXaxis()->SetAxisColor(gPad->GetFrameLineColor());
  grParticleWaterOnly1->GetXaxis()->SetLabelSize(0.05);
  grParticleWaterOnly1->GetXaxis()->SetLabelFont(42);
  grParticleWaterOnly1->GetXaxis()->SetTitleOffset(1.05);
  grParticleWaterOnly1->GetXaxis()->CenterTitle(1);
  grParticleWaterOnly1->GetXaxis()->SetTickLength(0.02);
  grParticleWaterOnly1->GetXaxis()->SetTitleSize(0.05);
  grParticleWaterOnly1->GetXaxis()->SetTitleFont(42);
  grParticleWaterOnly1->GetXaxis()->SetNdivisions(7);
  
  grParticleWaterOnly1->GetYaxis()->SetTitleColor(gPad->GetFrameLineColor());
  grParticleWaterOnly1->GetYaxis()->SetLabelColor(gPad->GetFrameLineColor());
  grParticleWaterOnly1->GetYaxis()->SetAxisColor(gPad->GetFrameLineColor());
  grParticleWaterOnly1->GetYaxis()->SetLabelSize(0.05);
  grParticleWaterOnly1->GetYaxis()->SetLabelFont(42);
  grParticleWaterOnly1->GetYaxis()->SetTitleOffset(0.9);
  grParticleWaterOnly1->GetYaxis()->CenterTitle(1);
  grParticleWaterOnly1->GetYaxis()->SetTickLength(0.02);
  grParticleWaterOnly1->GetYaxis()->SetTitleSize(0.05);
  grParticleWaterOnly1->GetYaxis()->SetTitleFont(42);
  grParticleWaterOnly1->GetYaxis()->SetNdivisions(7);

  // -----------------------------
  
  grParticleWaterOnly1->SetTitle("Fast neutrons attenuation - prim. + sec. neutrons");
  grParticleWaterOnly1->GetXaxis()->SetTitle("Water layer thickness (mm)");

  if (RealFlux)
    grParticleWaterOnly1->GetYaxis()->SetTitle("# survival particles after Igloo (kHz)");
  else
    grParticleWaterOnly1->GetYaxis()->SetTitle("Attenuation (%)");
  ...
  grParticleWaterOnly1->GetYaxis()->SetRangeUser(LowerLimitY,UpperLimitY);
  grParticleWaterOnly1->GetXaxis()->SetRangeUser(LowerLimitX,UpperLimitX);
  ...
  grParticleWaterOnly1->SetMarkerSize(grParticleWaterOnly0->GetMarkerSize());
  ...
  grParticleWaterOnly2->SetMarkerSize(grParticleWaterOnly1->GetMarkerSize());
  ...
  if (RealFlux) {
    ...
    grTotal->SetLineStyle(grParticleWaterOnly1->GetLineStyle());
    grTotal->SetMarkerStyle(5);
    grTotal->SetMarkerSize(grParticleWaterOnly1->GetMarkerSize());
  ...
  grLegendBWater->SetLineWidth(grParticleWaterOnly1->GetLineWidth());
  grLegendBWater->SetLineStyle(grParticleWaterOnly1->GetLineStyle());
  ...
  grParticleGeneratorWaterOnly1->GetXaxis()->SetAxisColor(gPad->GetFrameLineColor());
  grParticleGeneratorWaterOnly1->GetYaxis()->SetAxisColor(gPad->GetFrameLineColor());
  
  grParticleGeneratorWaterOnly1->GetXaxis()->SetTitleColor(gPad->GetFrameLineColor());
  grParticleGeneratorWaterOnly1->GetXaxis()->SetLabelColor(gPad->GetFrameLineColor());
  grParticleGeneratorWaterOnly1->GetXaxis()->SetAxisColor(gPad->GetFrameLineColor());
  grParticleGeneratorWaterOnly1->GetXaxis()->SetLabelSize(0.05);
  grParticleGeneratorWaterOnly1->GetXaxis()->SetLabelFont(42);
  grParticleGeneratorWaterOnly1->GetXaxis()->SetTitleOffset(1.05);
  grParticleGeneratorWaterOnly1->GetXaxis()->CenterTitle(1);
  grParticleGeneratorWaterOnly1->GetXaxis()->SetTickLength(0.02);
  grParticleGeneratorWaterOnly1->GetXaxis()->SetTitleSize(0.05);
  grParticleGeneratorWaterOnly1->GetXaxis()->SetTitleFont(42);
  grParticleGeneratorWaterOnly1->GetXaxis()->SetNdivisions(7);
  
  grParticleGeneratorWaterOnly1->GetYaxis()->SetTitleColor(gPad->GetFrameLineColor());
  grParticleGeneratorWaterOnly1->GetYaxis()->SetLabelColor(gPad->GetFrameLineColor());
  grParticleGeneratorWaterOnly1->GetYaxis()->SetAxisColor(gPad->GetFrameLineColor());
  grParticleGeneratorWaterOnly1->GetYaxis()->SetLabelSize(0.05);
  grParticleGeneratorWaterOnly1->GetYaxis()->SetLabelFont(42);
  grParticleGeneratorWaterOnly1->GetYaxis()->SetTitleOffset(0.9);
  grParticleGeneratorWaterOnly1->GetYaxis()->CenterTitle(1);
  grParticleGeneratorWaterOnly1->GetYaxis()->SetTickLength(0.02);
  grParticleGeneratorWaterOnly1->GetYaxis()->SetTitleSize(0.05);
  grParticleGeneratorWaterOnly1->GetYaxis()->SetTitleFont(42);
  grParticleGeneratorWaterOnly1->GetYaxis()->SetNdivisions(7);

  // ----------------------------
  
  grParticleGeneratorWaterOnly1->SetTitle("Fast neutrons attenuation - prim. neutrons");
  grParticleGeneratorWaterOnly1->GetXaxis()->SetTitle(grParticle0->GetXaxis()->GetTitle());
  grParticleGeneratorWaterOnly1->GetYaxis()->SetTitle(grParticle0->GetYaxis()->GetTitle());
  grParticleGeneratorWaterOnly1->SetLineStyle(1);

  grParticleGeneratorWaterOnly1->GetYaxis()->SetRangeUser(LowerLimitY,UpperLimitY);
  grParticleGeneratorWaterOnly1->GetXaxis()->SetRangeUser(LowerLimitX,UpperLimitX);
  ...
  grParticleGeneratorWaterOnly1->SetMarkerSize(grParticleWaterOnly1->GetMarkerSize());
  grParticleGeneratorWaterOnly1->SetMarkerColor(grParticle1->GetLineColor());
  // grParticleGeneratorWaterOnly1->Draw("SAMELP");
  grParticleGeneratorWaterOnly1->Draw("ALP");
  ...
  grParticleGeneratorWaterOnly2->SetMarkerSize(grParticleWaterOnly1->GetMarkerSize());
  ...
  grParticleWaterOnlyGamma1->GetXaxis()->SetAxisColor(gPad->GetFrameLineColor());
  grParticleWaterOnlyGamma1->GetYaxis()->SetAxisColor(gPad->GetFrameLineColor());
  
  grParticleWaterOnlyGamma1->GetXaxis()->SetTitleColor(gPad->GetFrameLineColor());
  grParticleWaterOnlyGamma1->GetXaxis()->SetLabelColor(gPad->GetFrameLineColor());
  grParticleWaterOnlyGamma1->GetXaxis()->SetAxisColor(gPad->GetFrameLineColor());
  grParticleWaterOnlyGamma1->GetXaxis()->SetLabelSize(0.05);
  grParticleWaterOnlyGamma1->GetXaxis()->SetLabelFont(42);
  grParticleWaterOnlyGamma1->GetXaxis()->SetTitleOffset(1.05);
  grParticleWaterOnlyGamma1->GetXaxis()->CenterTitle(1);
  grParticleWaterOnlyGamma1->GetXaxis()->SetTickLength(0.02);
  grParticleWaterOnlyGamma1->GetXaxis()->SetTitleSize(0.05);
  grParticleWaterOnlyGamma1->GetXaxis()->SetTitleFont(42);
  grParticleWaterOnlyGamma1->GetXaxis()->SetNdivisions(7);
  
  grParticleWaterOnlyGamma1->GetYaxis()->SetTitleColor(gPad->GetFrameLineColor());
  grParticleWaterOnlyGamma1->GetYaxis()->SetLabelColor(gPad->GetFrameLineColor());
  grParticleWaterOnlyGamma1->GetYaxis()->SetAxisColor(gPad->GetFrameLineColor());
  grParticleWaterOnlyGamma1->GetYaxis()->SetLabelSize(0.05);
  grParticleWaterOnlyGamma1->GetYaxis()->SetLabelFont(42);
  grParticleWaterOnlyGamma1->GetYaxis()->SetTitleOffset(0.9);
  grParticleWaterOnlyGamma1->GetYaxis()->CenterTitle(1);
  grParticleWaterOnlyGamma1->GetYaxis()->SetTickLength(0.02);
  grParticleWaterOnlyGamma1->GetYaxis()->SetTitleSize(0.05);
  grParticleWaterOnlyGamma1->GetYaxis()->SetTitleFont(42);
  grParticleWaterOnlyGamma1->GetYaxis()->SetNdivisions(7);

  // ----------------------------
  
  grParticleWaterOnlyGamma1->SetTitle("Gamma production");
  grParticleWaterOnlyGamma1->GetXaxis()->SetTitle(grParticleWaterOnly1->GetXaxis()->GetTitle());
  grParticleWaterOnlyGamma1->GetYaxis()->SetTitle("# #gamma / generated neutrons");
  grParticleWaterOnlyGamma1->SetLineStyle(1);

  grParticleWaterOnlyGamma1->GetYaxis()->SetRangeUser(5e-4,3);//5e-4
  grParticleWaterOnlyGamma1->GetXaxis()->SetRangeUser(LowerLimitX,UpperLimitX);

  // Water only
  
  grParticleWaterOnlyGamma1->SetLineColor(grParticle1->GetLineColor());
  grParticleWaterOnlyGamma1->SetMarkerStyle(grParticle1->GetMarkerStyle());
  grParticleWaterOnlyGamma1->SetLineStyle(grParticleWaterOnly0->GetLineStyle());
  grParticleWaterOnlyGamma1->SetLineWidth(grParticleWaterOnly0->GetLineWidth());
  grParticleWaterOnlyGamma1->SetMarkerSize(grParticleWaterOnly1->GetMarkerSize());
  grParticleWaterOnlyGamma1->SetMarkerColor(grParticle1->GetLineColor());
  grParticleWaterOnlyGamma1->Draw("ALP");
  
  grParticleWaterOnlyGamma2->SetLineColor(grParticle2->GetLineColor());
  grParticleWaterOnlyGamma2->SetMarkerStyle(grParticle2->GetMarkerStyle());
  grParticleWaterOnlyGamma2->SetLineWidth(grParticleWaterOnly0->GetLineWidth());
  grParticleWaterOnlyGamma2->SetLineStyle(grParticleWaterOnly0->GetLineStyle());
  grParticleWaterOnlyGamma2->SetMarkerSize(grParticleWaterOnly1->GetMarkerSize());
  grParticleWaterOnlyGamma2->SetMarkerColor(grParticle2->GetLineColor());
  grParticleWaterOnlyGamma2->Draw("SAMELP");
